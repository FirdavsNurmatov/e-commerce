...
export const createreview = async ({
    ...
    if (!created_at || !updated_at) {
        var query =
            'Insert into reviews (user_id,product_id,rating,comment,created_at,updated_at) Values($1,$2,$3,$4,$5,$6) returning *'
...
export const updatereview = async ({
    ...
    if (!created_at || !updated_at) {
        ...
        const query =
            'Update reviews set user_id=$1,product_id=$2,rating=$3,comment=$4,created_at=$5,updated_at=$6 where id=$7 returning *'
        const arr = [
            user_id,
            product_id,
            rating,
